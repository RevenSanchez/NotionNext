...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎来到kuhup,这里每天都会更新漫圈资讯以及技术分享，感谢您的支持!🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'kuhup沙师弟（站长）', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '信奉共创、共享、开源的极致理想主义精神', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.kuhup.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，影视，动画，', // 网站关键词 英文逗号隔开
  ...
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/392597166?spm_id_from=333.337.0.0', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || '', // Youtube主页
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || '18116732744', // 你的微信个人主页
  ...
  // artalk 评论插件
  COMMENT_ARTALK_SERVER: process.env.NEXT_PUBLIC_COMMENT_ARTALK_SERVER || 'www.kuhup.com', // ArtalkServert后端地址 https://artalk.js.org/guide/deploy.html
  ...
  // twikoo
  COMMENT_TWIKOO_ENV_ID: process.env.NEXT_PUBLIC_COMMENT_ENV_ID || 'www.kuhup.com', // TWIKOO后端地址 腾讯云环境填envId；Vercel环境填域名，教程：https://tangly1024.com/article/notionnext-twikoo
