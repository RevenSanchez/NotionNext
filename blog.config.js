...
const BLOG = {
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'https://www.kuhup.com/archive', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_WECHAT: process.env.NEXT_PUBLIC_CONTACT_WECHAT || 'https://www.baidu.com', // 你的微信个人主页
