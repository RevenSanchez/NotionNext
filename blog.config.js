...
const BLOG = {
  ...
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'https://www.kuhup.com/article/number', // 邮箱地址 例如mail@tangly1024.com
  ...
  COMMENT_HIDE_SINGLE_TAB: process.env.NEXT_PUBLIC_COMMENT_HIDE_SINGLE_TAB || ture, // Whether hide the tab when there's no tabs. 只有一个评论组件时是否隐藏切换组件的标签页
